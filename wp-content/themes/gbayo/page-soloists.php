            ...
            <div class="container lightbox-container-inner-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 col-12 mb-30">
                        <img class="w-100" class="detail-musician-img" src="" alt="">
...
<div class="container mt-100">
    ...
    <div class="row  content-fsize">
        ...
        <div class="col-4">
            ...
            <a href="javascript:void(0);" class="content-fsize more-btn musician-more-btn d-block"
                ...
                <h3 class="mt-2 orange bold d-block text-dark mb-1"><?php echo get_field('musician_name');?> <div
...
$(function() {
    ...
    $('.musician-more-btn').click(function() {
        ...
        $('.lightbox-layer').find('img').attr('src',
            'http://64.227.13.14/gbayo/wp-content/uploads/2023/07/Asset-1@2x-50-3.jpg').addClass(
            'lazyloaded');
